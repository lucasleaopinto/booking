...
import (
	...
	"github.com/lucasleaopinto/bookings/internal/repository"
	"github.com/lucasleaopinto/bookings/internal/repository/dbrepo"
	"net/http"
	"strconv"
	"time"
...
func (m *Repository) ReservationSummary(w http.ResponseWriter, r *http.Request) {
	...
	if !ok {
		m.App.ErrorLog.Println("[ReservationSummary] - Can't get error from session")
